...
// uint8_t ADM0802A_Init (uint8_t num_pins_to_set, ...) {
// 	// //uint8_t ADM0802A_Init (GPIO_TypeDef* RW_port, uint16_t RW_pin);
...
// 	//		} else if (temp->Instance == TIM16) {
// 	//			HAL_TIM_Base_Stop_IT(&htim16);
// 	//			finished_once = 0;
// 	//			characters_to_move = va_arg(arg_list, int);
...
// //	switch (num) {
// //		case 14: {
// //			GPIO_TypeDef* port = va_arg (arg_list, GPIO_TypeDef*);
// //			uint16_t pin = va_arg (arg_list, uint16_t);
// //		}
// //		default: {
